...
export const useEventInfo = (routeEventInfo: EventInformation | null, userId: string) => {
    const [eventInformation, setEventInformation] = useState<EventInformation | null>(
        routeEventInfo,
    );
    ...
    const handleEventChange = async (newEvent: EventInformation): Promise<EventInformation> => {
