...
export const defaultCountryCode: CountryCode =
    countryCodes.find((country) => country.code === 'PK') || countryCodes[0];

export const findCountryByDialCode = (dialCode: string): CountryCode | undefined =>
    countryCodes.find((country) => country.dialCode === dialCode);

export const findCountryByCode = (code: string): CountryCode | undefined =>
    countryCodes.find((country) => country.code === code);
